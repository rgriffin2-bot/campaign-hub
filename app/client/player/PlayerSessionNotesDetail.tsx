...
export function PlayerSessionNotesDetail() {
  ...
  const { get, delete: deleteMutation } = usePlayerFiles('session-notes');
  ...
  const handleDelete = async () => {
    ...
    navigate('/player/modules/session-notes');
  };
  ...
  if (!notes) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center">
        ...
        <Link
          to="/player/modules/session-notes"
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link
            to={`/player/modules/session-notes/${fileId}/edit`}
