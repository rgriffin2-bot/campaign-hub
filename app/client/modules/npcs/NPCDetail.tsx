...
export function NPCDetail() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      {(() => {
        const showStats = frontmatter.hasStats ?? frontmatter.isAntagonist;
        const stats = frontmatter.stats ?? frontmatter.antagonistStats;
          ...
          <div className="rounded-lg border border-red-500/30 bg-red-500/5 p-4">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-lg border border-red-500/20 bg-background p-3">
                ...
                <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-muted">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, ((stats.damage || 0) / (stats.maxDamage || 10)) * 100)}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div className="rounded-lg border border-border bg-background p-3">
                ...
                <div className="mt-2">
                  {(stats.damage || 0) >= (stats.maxDamage || 10) ? (
                    <span className="text-lg font-bold text-red-500">Defeated</span>
                  ) : (stats.damage || 0) >= ((stats.maxDamage || 10) * 0.5) ? (
            ...
            {stats.moves && (
              <div className="mt-4">
                ...
                <div className="mt-2 rounded-lg border border-border bg-background p-3">
                  <MarkdownContent content={stats.moves} />
                </div>
              </div>
            )}
          </div>
