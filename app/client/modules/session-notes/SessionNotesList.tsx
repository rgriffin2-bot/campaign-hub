...
function SessionNotesCard({ item }: { item: FileMetadata }) {
  return (
    <Link
      to={`/modules/session-notes/${item.id}`}
      className="group relative rounded-lg border border-border bg-card p-4 transition-colors hover:border-primary/50 hover:bg-accent"
    >
