/**
 * FactionImageUpload -- image upload widget with drag-to-reposition and zoom.
 * Square aspect ratio for faction logos/emblems.
 */

import { useState, useRef, useCallback, useEffect } from 'react';
import { Upload, X, Shield, ZoomIn, ZoomOut, Move } from 'lucide-react';
...
export function FactionImageUpload({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/campaigns/${campaign.id}/faction-images/${factionId}`,
  ...
  return (
    <div className="space-y-4">
      {/* Preview area - Square for faction logos/emblems */}
      <div className="flex items-start gap-4">
        <div
          ref={previewRef}
          className="relative h-48 w-48 shrink-0 overflow-hidden rounded-lg border-2 border-border bg-secondary"
